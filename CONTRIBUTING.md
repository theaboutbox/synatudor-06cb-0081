...
attach `CalibrationData.blob`, `PairingData.blob`, `CryptoRegistry.blob`,
files from `/var/lib/tudor` or `/var/lib/fprint`, fingerprint captures, or
unedited debug logs. They can contain sensor-specific state, enrollment
